...
const legacyMessageKeyMap: Record<string, string> = {
  ...
  "Sign out": "settingsPage.signOut",
  "Signing out...": "settingsPage.signingOut",
  "Failed to sign out.": "settingsPage.signOutFailed",
  "Use this to proactively end the current admin session on this browser.": "settingsPage.signOutDescription",
  "Alert delivery status": "settingsPage.dispatcherHealthLabel",
  "Normal": "settingsPage.dispatcherHealthNormal",
  "Backlogged": "settingsPage.dispatcherHealthBacklogged",
  "Drops detected": "settingsPage.dispatcherHealthDropped",
  "Dispatcher Diagnostics": "settingsPage.dispatcherDiagnosticsTitle",
  "Runtime visibility for alert queue pressure and delivery throughput.": "settingsPage.dispatcherDiagnosticsDescription",
  "Loading dispatcher diagnostics...": "settingsPage.dispatcherDiagnosticsLoading",
  "Dispatcher diagnostics are currently unavailable.": "settingsPage.dispatcherDiagnosticsUnavailable",
  "Active dispatchers": "settingsPage.dispatcherActiveDispatchers",
  "Total capacity": "settingsPage.dispatcherTotalCapacity",
  "Queue depth": "settingsPage.dispatcherQueueDepth",
  "High watermark": "settingsPage.dispatcherHighWatermark",
  "Enqueued": "settingsPage.dispatcherEnqueued",
  "Processed": "settingsPage.dispatcherProcessed",
  "Dropped": "settingsPage.dispatcherDropped",
  ...
  "Resource Usage": "nodeDetail.resourceUsage",
  "Throughput / Traffic": "nodeDetail.throughputTraffic",
  "Network Traffic": "nodeDetail.networkTraffic",
  "Disk Usage": "nodeDetail.diskUsage",
  "Disk IO": "nodeDetail.diskIo",
  "Disk Read Speed": "nodeDetail.diskReadSpeed",
  "Disk Write Speed": "nodeDetail.diskWriteSpeed",
